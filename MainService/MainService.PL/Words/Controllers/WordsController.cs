...
namespace MainService.PL.Words.Controllers
{
    ...
    public class WordsController : ControllerBase
    {
        ...
        // Add a word
        [HttpPost]
        public async Task<IActionResult> AddWord([FromBody] Word word, CancellationToken cancellationToken)
        {
            if (word == null)
                return BadRequest();
        ...
        public async Task<IActionResult> DeleteWord(Guid id, CancellationToken cancellationToken)
        {
            ...
            await _wordService.DeleteWordAsync(word, cancellationToken);
            return NoContent();
        }
    }
}