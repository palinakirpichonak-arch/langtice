...
public interface ILanguageService
{
    ...
    Task<IEnumerable<ResponseLanguageDto>> GetAllAsync(CancellationToken cancellationToken);
    Task<PaginatedList<ResponseLanguageDto>> GetAllAsync(int pageIndex, int pageSize, CancellationToken cancellationToken);
